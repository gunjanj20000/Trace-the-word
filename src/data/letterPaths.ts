...
export const RAW_LETTERS: Record<string, string[]> = {
  ...
  O: [
    'M 100 35 C 45 35, 28 75, 28 120 C 28 165, 45 205, 100 205',   // Left half (top to bottom) - anti-clockwise
    'M 100 205 C 155 205, 172 165, 172 120 C 172 75, 155 35, 100 35', // Right half (bottom to top) - anti-clockwise
  ],
  P: [
    'M 45 35 L 45 205',                                              // Vertical stem
